...
class DicountedCart(ShoppingCart):
    ...
    def cart_contents(self):
        super().cart_contents()
        print(f"Discount ({self.discount_rate*100:.0f}%): Ksh {super().calculate_total() * self.discount_rate:.2f}")
        print(f"Final Total after discount: Ksh {self.calculate_total():.2f}\n")
...
class TaxedCart(ShoppingCart):
    ...
    def cart_contents(self):
        super().cart_contents()
        print(f"Tax ({self.tax_rate*100:.0f}%): Ksh {super().calculate_total() * self.tax_rate:.2f}")
        print(f"Final Total after tax: Ksh {self.calculate_total():.2f}\n")
